        ...
        <div className="container-paket-snbt">
          <div className="card-paket-snbt">
            ...
            <p className="isi-paket-snbt">
              ...
              dengan kebutuhan siswa sehingga menciptakan lingkungan belajar
              yang kondusif dan minim distraksi
            </p>
            <p className="isi-paket-snbt">
              <FontAwesomeIcon className="icon-paket-snbt" icon={faCheck} />{" "}
            ...
            <p className="isi-paket-snbt">
              <FontAwesomeIcon className="icon-paket-snbt" icon={faCheck} />{" "}
              Free Biaya Pendaftaran SNBT 2025
            </p>
            <p className="isi-paket-snbt">
              <FontAwesomeIcon className="icon-paket-snbt" icon={faCheck} />{" "}
          ...
          <div className="card-paket-snbt">
            ...
            <p className="isi-paket-snbt">
              <FontAwesomeIcon className="icon-paket-snbt" icon={faCheck} />{" "}
              Tersedia pembelajaran Online dan Offline
            </p>
            <p className="isi-paket-snbt">
              <FontAwesomeIcon className="icon-paket-snbt" icon={faCheck} />{" "}
              Jadwal Belajar fleksible sesuai dengan kebutuhan siswa
            </p>
            <p className="isi-paket-snbt">
              <FontAwesomeIcon className="icon-paket-snbt" icon={faCheck} />{" "}
              Durasi Belajar 90 menit atau 120 menit
            </p>
            <p className="isi-paket-snbt">
              <FontAwesomeIcon className="icon-paket-snbt" icon={faCheck} />{" "}
              Free Pendaftaran
