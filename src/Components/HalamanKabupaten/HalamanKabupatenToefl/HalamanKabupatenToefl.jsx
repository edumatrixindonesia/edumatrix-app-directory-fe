    ...
    <React.Fragment>
      <Helmet>
        <meta
          charSet="utf-8"
          name="description"
          content="Les Privat TOEFL, TOEIC, IELTS, and English Conversation Lessons, SMP - SMA - Mahasiswa terbaik dengan sistem belajar mengajar yang berkualitas #1 - Edumatrix Indonesia"
        />
        <title>
          Les Privat TOEFL, TOEIC, IELTS, and English Conversation
          Lessons in {`${kabupaten.kota_kabupaten}`} #1 - Edumatrix Indonesia
        </title>
        <link rel="canonical" href={`https://app.edumatrix-indonesia.com/bimbel-toefl-toeic-ielts-dan-english-conversation/kabupaten/${kabupaten.slug}`} />
      </Helmet>
      <NavbarIgcse />
        ...
        <div className="content-kabupaten">
          <div className="teks-content">
            <h2 className="title-halaman-kabupaten">
              {t("halamanKotaToefl.title")} {kabupaten.kota_kabupaten} -
              Edumatrix Indonesia
            </h2>
            <div className="paragraf-kabupaten">
              <p>
                {t("halamanKotaToefl.desk_1")} {kabupaten.kota_kabupaten}
              </p>
