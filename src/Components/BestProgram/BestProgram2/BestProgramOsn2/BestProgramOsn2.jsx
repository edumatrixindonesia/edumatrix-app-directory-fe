...
const BestProgramOsn2 = () => {
  ...
  const fetchProgram_2 = () => {
    fetch("https://api.edulink-indonesia.com/bestprogramosn2")
      .then((res) => res.json())
      .then((data) => {
        setProgram_2(data);
        data;
  ...
  return (
    <React.Fragment>
      ...
      <div className="main-best-program-2">
        <h1 className="title-best-program-2">BEST PROGRAM <br /> BIMBEL OSN</h1>
...
export default BestProgramOsn2;
