...
const BestProgramCpns2 = () => {
    ...
    const fetchProgram_2 = () => {
      fetch("https://api.edulink-indonesia.com/bestprogramcpns2")
        .then((res) => res.json())
        .then((data) => {
          setProgram_2(data);
          (data);
    ...
    return (
      ...
      <div className="main-best-program-2">
        <h1 className="title-best-program-2">BEST PROGRAM <br /> BIMBEL CPNS</h1>
...
export default BestProgramCpns2;