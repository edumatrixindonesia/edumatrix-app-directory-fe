...
const Bestprogram = () => {
  ...
  const fetchProgram = () => {
    fetch("https://api.edulink-indonesia.com/bestprogram")
      .then((res) => res.json())
      .then((data) => {
        setProgram(data);
        (data);
    ...
    <React.Fragment>
      <div className="main-box">
        <div className="main-best-program">
          <h1 className="title-best-program">BEST PROGRAM</h1>
          <h3 className="hot-program">
            <img className="icon-hot-program" src={hotProgram} alt="Bimbel Privat Terbaik" /> HOTS
            PROGRAM
          </h3>
        ...
        >
          <img className="model-tanya-program" src={modelTanyaProgram} alt="Bimbel Privat Terbaik" />
        </a>
      </div>
    </React.Fragment>
  );
