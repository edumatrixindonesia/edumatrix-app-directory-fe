      ...
      <div className="main-box">
        <div className="main-best-program">
          <h1 className="title-best-program">
            SPESIAL PROGRAM MASUK PTN
          </h1>
          <h3 className="hot-program">
            <img className="icon-hot-program" src={hotProgram} alt="Bimbel UTBK SNBT Terbaik - Edumatrix Indonesia" /> HOTS
            PROGRAM
          </h3>
        ...
        >
          <img className="model-tanya-program" src={modelTanyaProgram} alt="Bimbel Masuk PTN Terbaik" />
        </a>
      </div>
    </React.Fragment>
  );
