      ...
      <div className="main-box">
        <div className="main-best-program">
          <h1 className="title-best-program">
            BEST PROGRAM <br/> LES PRIVAT
          </h1>
          <h3 className="hot-program">
            <img className="icon-hot-program" src={hotProgram} alt="Bimbel Masuk TNI - Polri" /> HOTS
            PROGRAM
          </h3>
        ...
        >
          <img className="model-tanya-program" src={modelTanyaProgram} alt="Bimbel Sekolah Kedinasa Terbaik" />
        </a>
      </div>
    </React.Fragment>
  );
...
export default BestprogramPrivat;
