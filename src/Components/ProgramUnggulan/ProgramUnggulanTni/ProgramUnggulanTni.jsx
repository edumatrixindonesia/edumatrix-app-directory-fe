    ...
    <React.Fragment>
      <div className="container-program-unggulan-tni">
        <div className="card-program-unggulan">
          ...
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} /> Tips
            & Trik Lulus Tes
          </p>
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} />{" "}
          ...
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} /> Free
            Konsultasi
          </p>
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} />{" "}
        ...
        <div className="card-program-unggulan">
          ...
          <h4 className="title-fitur">Fitur Program</h4>
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} /> CAMP
            Selama 4 Minggu
          </p>
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} />{" "}
          ...
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} /> Grup
            Belajar Exclusive
          </p>
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} /> Free
            Assesment tes Akademik, SKD & Psikologi
          </p>
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} />{" "}
          ...
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} /> Full
            Akomodasi selama CAMP
          </p>
          <p className="isi-fitur-program">
            <FontAwesomeIcon className="icon-program-tni" icon={faCheck} />{" "}
            Motivation Training
